...
int pkt_recycle(knot_pkt_t *pkt, uint16_t keep_question)
{
	/* The maximum size of a header + query name + (class, type) */
	static uint8_t buf[KNOT_WIRE_HEADER_SIZE + KNOT_DNAME_MAXLEN + 2 * sizeof(uint16_t)];
